...
export module AsyncValueUtils {
    ...
    const registerLoadAction = <ST, SL extends keyof ST, SA extends keyof ST[SL], AT extends string>(
    ...
    const registerSuccessAction = <ST, SL extends keyof ST & string, SA extends keyof ST[SL], V extends (ST[SL][SA] extends AsyncValue<infer U> ? U : never), AT extends string>(
        rootReducerManager: RootReducerManager,
        stateLabel: SL,
        stateAttribute: SA,
        actionType: AT) => {
